...
docker run --rm -v $(pwd)/data:/github/workspace/data/ --workdir /github/workspace/data/ mborejdo/action-rusty "faviconr --bg '#000000' --fg '#ffffff' --font ./fonts/FinkHeavy.ttf --offset 20 --scale 80 --output ./" ""
